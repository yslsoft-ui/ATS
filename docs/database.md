...
## 4. 데이터베이스 마이그레이션 및 일회성 복구 정책 (Database Migrations)

### 4.1. KIS is_active 오염 복구 로직 비활성화
...
### 4.2. 실거래(live) 포트폴리오 초기 투자원금 및 ROI 복구 마이그레이션
...
## 5. 포트폴리오 ID 정수화 (Integer Portfolio IDs)

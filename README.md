...
| **아키텍처 결정 기록 (ADR)** | [docs/adr/](file:///home/simon/ATS/docs/adr/) | 포트폴리오 매니저 분리 및 실시간 국소 복기·카운터팩츄얼 대조 기반 챔피언 전략 순환 매매 비전 선언(ADR 0008), 클린업 데몬 동시성 제어 및 ACK 프로토콜(ADR 0009), 자동 상장 및 상장폐지 감지/스케줄링 아키텍처(ADR 0010) 등 주요 결정 이력 |

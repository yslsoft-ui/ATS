...
async def main():
    ...
    # 데이터 정리 서비스 생성
    service = MarketDataCleanupService(
        config_manager=config_manager,
        event_bus=event_bus
    )

    # Supervisor 생성 및 기동 (Market Data Cleanup Daemon)
    supervisor = DaemonSupervisor(
        daemon_name="market_cleanup_daemon",
        service=service,
        event_bus=event_bus,
        ...
        config_manager=config_manager,
        control_topic="market_cleanup_control"
    )

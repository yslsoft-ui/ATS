...
class MarketHours:
    ...
    @classmethod
    def is_krx_open(cls, dt: datetime.datetime = None) -> bool:
        """
        국내 주식(KRX) 장 운영 시간인지 확인합니다.
        평일 09:00 ~ 15:30 (준비 시간 포함 08:30 ~ 16:00 허용)
        """
        if dt is None:
        ...
        # 2. 시간 체크 (08:30 ~ 16:00)
        # 실제 장은 09:00에 열리지만, 접속 및 데이터 준비를 위해 약간 일찍 열어둠
    ...
    @classmethod
    def time_until_open(cls, exchange: str = 'kis') -> float:

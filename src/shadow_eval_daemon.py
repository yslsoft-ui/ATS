...
async def main():
    ...
    # Supervisor 생성 및 기동 (Shadow Evaluation Daemon)
    supervisor = DaemonSupervisor(
        daemon_name="shadow_eval_daemon",
        service=service,
        event_bus=event_bus,
        ...
        config_manager=config_manager,
        control_topic="shadow_eval_control"
    )

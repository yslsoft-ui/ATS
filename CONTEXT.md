...
**Challenger (챌린저 전략)**:
그림자 리그(SHADOW 상태)에서 실시간으로 테스트를 받으며 챔피언 전략의 성능과 경쟁하는 후보 전략.
...
잦은 실전 전략 교체로 인한 계좌 불안정성을 방지하기 위해, 신임 챔피언 전략으로 가동 전환된 이후 **최소 7일 경과 AND 최소 100건 거래 완료** 조건이 동시에 충족될 때까지는 타 챌린저에 의한 강제 강등을 유예하는 안전장치.
